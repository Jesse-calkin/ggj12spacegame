	...
	public class EndGameState extends FlxState
	{
		...
		override public function create():void
		{
			...
			if (!Registry.player1Planet.alive)
			{
				...
				player2Win.setFormat (null, 64, Registry.menuorange, "center");
				add(player2Win);
				Registry.p2score += 1;
			}
			...
			else if (!Registry.player2Planet.alive)
			{
				...
				player1Win.setFormat (null, 64, Registry.menublue, "center");
				add(player1Win);
				Registry.p1score += 1;
			}
			winnerSound.play();
			...
			p1scoreText.setFormat (null, 120, Registry.menublue, "left");
			add(p1scoreText);
